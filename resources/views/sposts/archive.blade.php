...
<table class="table table-sm posts-table-large" >
  ...
  <thead>
    <tr>
      <th scope="col" style="width: 300px;">Posted on</th>
      <th scope="col" style="width: 1200px;">Shared to followers</th>
      <th scope="col" style="width: 300px;">From</th>
      <th scope="col" style="width: 300px;">RT's</th>
      <th scope="col" style="width: 300px;">Likes</th>
    </tr>
  </thead>
  ...
  <tbody>
    ...
    @empty
        <p class="posts-table-large">Nothing posted yet.
            <a href="{{ route('sposts.schedule') }}" style="color:#3490dc;">
                <span>Go create a post.</span>
            </a>
        </p>
    @endforelse
